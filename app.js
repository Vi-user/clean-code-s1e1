...
var incompleteTaskHolder=document.getElementById("future-tasks");//ul of #future-tasks
...
var createNewTaskElement=function(taskString){
    ...
    listItem.className="tasks-list__item list-item"
    ...
    editInput.type="text";
    editInput.className="task task__input list-item__input";
...
//Mark task as incomplete.
    ...
    //Append the task list item to the #future-tasks.
    var listItem=this.parentNode;
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
